...
export default function Profile() {
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      {/* Booked Listings */}
      {bookedListings && bookedListings.length > 0 && (
        <div className="flex flex-col gap-4 mt-10">
          <h2 className="text-center text-xl font-semibold text-red-600">Booked Listings</h2>
          {bookedListings.map((listing) => (
            <div
              key={listing._id}
              className="border rounded-lg p-3 flex justify-between items-center gap-4 bg-red-50"
            >
              <Link to={`/listing/${listing._id}`}>
                <img src={listing.imageUrls[0]} alt="listing cover" className="h-16 w-16 object-contain" />
              </Link>
